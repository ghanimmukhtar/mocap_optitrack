...
//        ROS_INFO_STREAM("Position of other markers X: " << model.otherMarkers[l].positionX << " Y: "
//                        << model.otherMarkers[l].positionY << " Z: "
//                        << model.otherMarkers[l].positionZ);
        _free_markers_positions.push_back({model.otherMarkers[l].positionX,
                                          model.otherMarkers[l].positionY,
                                          model.otherMarkers[l].positionZ});
    }
